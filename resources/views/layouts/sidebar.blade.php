      ...
      <div class="py-4 text-gray-500">
          <div>
              <a href="{{ route('dashboard') }}" class="flex items-center pl-4">
                  <img class="h-20 w-20 rounded-full" src="{{ asset('assets/logo.png') }}" alt="">
              </a>
          </div>
          {{-- dashboard --}}
          <ul class="mt-6">
                  ...
                  <template x-if="isNewsMenuOpen">
                      <ul x-transition:enter="transition-all ease-in-out duration-300"
                          ...
                          <li
                              ...
                              <a class="w-full" href="pages/news-list.html">News List</a>
                          </li>
                          <li
                              class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
              ...
              <li class="relative px-6 py-3">
                  ...
                  <template x-if="isCMSMenuOpen">
                      <ul x-transition:enter="transition-all ease-in-out duration-300"
                          ...
                          <li
                              class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                              <a class="w-full" href="pages/header.html">Header</a>
                          </li>
                          <li
                              class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                              <a class="w-full" href="pages/hero-section.html">Hero Section</a>
                          </li>
                          <li
                              class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
